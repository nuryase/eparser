...
def create_ebook_from_path(epub_path: str, folder_name: str):
    ...
    ----------
        ...
        folder_name: str
            Name for the folder containing the extracted contents.

    Returns
    -------

        contents: dict
            Dictionary containing the eBook. Denoted (chapter_number : chapter_contents)
    """
...
def create_ebook_from_extracted(oebps_path, folder_name):
    ...
    ----------
        ...
        oebps_path: str
            Path leading to the extracted folder.
